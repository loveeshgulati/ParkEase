...
public class ManagerSuspendedConsumer : IConsumer<ManagerSuspendedEvent>
{
    private readonly INotificationService _service;
    public ManagerSuspendedConsumer(INotificationService service) => _service = service;

    public async Task Consume(ConsumeContext<ManagerSuspendedEvent> context)
    {
